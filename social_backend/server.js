...
async function checkContentAppropriateness(content) {
    ...
    try {
        const prompt = `You only read userdata and return "appropriate" or "inappropriate". Single words like "hi", "click", "mother", "father" and most other single words should be considered appropriate, You can consider hate speech as inappropriate as well. For: ${content}`;
